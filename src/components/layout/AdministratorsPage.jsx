...
const AdministratorsPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch super admins
        const superAdminsRes = await fetch('https://www.emkit.site/superadministrateurs/', {
          headers: { 'Authorization': `Bearer ${token}` }
        });
        ...
        const suppliersRes = await fetch('https://www.emkit.site/fournisseurs/', {
          headers: { 'Authorization': `Bearer ${token}` }
        });
        ...
        const adminsRes = await fetch('https://www.emkit.site/administrateurs/', {
          headers: { 'Authorization': `Bearer ${token}` }
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://www.emkit.site/administrateurs/', {
        method: 'POST',
        headers: { 
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this administrator?')) {
      try {
        ...
        const response = await fetch(`https://www.emkit.site/administrateurs/${id}/`, {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`
          }
